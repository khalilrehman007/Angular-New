...
export class CometChatIncomingCallComponent implements OnInit,OnDestroy{
  ...
  INCOMING_AUDIO_CALL: any = COMETCHAT_CONSTANTS.INCOMING_AUDIO_CALL;
  INCOMING_VIDEO_CALL: any = COMETCHAT_CONSTANTS.INCOMING_VIDEO_CALL;
  DECLINE: any = COMETCHAT_CONSTANTS.DECLINE;
  ACCEPT: any = COMETCHAT_CONSTANTS.ACCEPT;
