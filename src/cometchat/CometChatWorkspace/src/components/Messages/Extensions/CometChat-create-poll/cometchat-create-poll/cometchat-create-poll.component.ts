...
export class CometChatCreatePollComponent implements OnInit {
  ...
  inputOptionOne: any = "";
  inputOptionTwo: any = "";
  inputOptionItems: {key: any, value: any}[] = [];
  

  @Output() actionGenerated: EventEmitter<any> = new EventEmitter();

  createBtnText = COMETCHAT_CONSTANTS.CREATE;
  CREATE_POLL: any = COMETCHAT_CONSTANTS.CREATE_POLL;
  QUESTION: any = COMETCHAT_CONSTANTS.QUESTION;
  ENTER_YOUR_QUESTION: any = COMETCHAT_CONSTANTS.ENTER_YOUR_QUESTION;
  OPTIONS: any = COMETCHAT_CONSTANTS.OPTIONS;
  ENTER_YOUR_OPTION: any = COMETCHAT_CONSTANTS.ENTER_YOUR_OPTION;
  ADD_NEW_OPTION: any = COMETCHAT_CONSTANTS.ADD_NEW_OPTION;
