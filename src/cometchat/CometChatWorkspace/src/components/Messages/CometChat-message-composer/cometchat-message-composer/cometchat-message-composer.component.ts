...
export class CometChatMessageComposerComponent implements OnInit, OnChanges {
  ...
  PICK_YOUR_EMOJI: any = COMETCHAT_CONSTANTS.PICK_YOUR_EMOJI;
  ATTACH_FILE: any = COMETCHAT_CONSTANTS.ATTACH_FILE;
  ATTACH_VIDEO: any = COMETCHAT_CONSTANTS.ATTACH_VIDEO;
  ATTACH_AUDIO: any = COMETCHAT_CONSTANTS.ATTACH_AUDIO;
  ATTACH_IMAGE: any = COMETCHAT_CONSTANTS.ATTACH_IMAGE;
  ADD_EMOJI: any = COMETCHAT_CONSTANTS.ADD_EMOJI;
  ENTER_YOUR_MESSAGE_HERE: any = COMETCHAT_CONSTANTS.ENTER_YOUR_MESSAGE_HERE;
  EDIT_MESSAGE: any = COMETCHAT_CONSTANTS.EDIT_MESSAGE;
