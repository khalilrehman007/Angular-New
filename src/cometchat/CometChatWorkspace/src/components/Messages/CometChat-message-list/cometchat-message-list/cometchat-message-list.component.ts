...
export class CometChatMessageListComponent
  ...
  MESSAGE_TYPE_TEXT: any = CometChat.MESSAGE_TYPE.TEXT;
  MESSAGE_TYPE_IMAGE: any = CometChat.MESSAGE_TYPE.IMAGE;
  MESSAGE_TYPE_VIDEO: any = CometChat.MESSAGE_TYPE.VIDEO;
  MESSAGE_TYPE_AUDIO: any = CometChat.MESSAGE_TYPE.AUDIO;
  MESSAGE_TYPE_FILE: any = CometChat.MESSAGE_TYPE.FILE;
  MESSAGE_TYPE_CUSTOM: any = CometChat.MESSAGE_TYPE.CUSTOM;
  CALL_TYPE_AUDIO: any = CometChat.CALL_TYPE.AUDIO;
  CALL_TYPE_VIDEO: any = CometChat.CALL_TYPE.VIDEO;
  CATEGORY_MESSAGE: any = CometChat.CATEGORY_MESSAGE;
  CATEGORY_ACTION: any = CometChat.CATEGORY_ACTION;
  CATEGORY_CALL: any = CometChat.CATEGORY_CALL;
  DIRECT_CALL: any = enums.CALL_TYPE_DIRECT;
   ...
   * @param
   */
  buildMessageRequestObject(item: any = null, type: any = '', parentMessageId: number) {
