...
@Component({
  selector: "cometchat-receiver-directcall-bubble",
  templateUrl: "./cometchat-receiver-directcall-bubble.component.html",
  styleUrls: ["./cometchat-receiver-directcall-bubble.component.css"],
})
export class CometChatReceiverDirectCallBubbleComponent implements OnInit {
  @Input() item = null;
  @Input() type: any = "";
