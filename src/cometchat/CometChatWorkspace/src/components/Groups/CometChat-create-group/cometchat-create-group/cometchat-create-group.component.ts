...
export class CometChatCreateGroupComponent implements OnInit {
  ...
  createBtnText: any = COMETCHAT_CONSTANTS.CREATE;
  SELECT_GROUP_TYPE: any = COMETCHAT_CONSTANTS.SELECT_GROUP_TYPE;
  ENTER_GROUP_NAME: any = COMETCHAT_CONSTANTS.ENTER_GROUP_NAME;
  PUBLIC: any = COMETCHAT_CONSTANTS.PUBLIC;
  PRIVATE: any = COMETCHAT_CONSTANTS.PRIVATE;
  PASSWORD_PROTECTED: any = COMETCHAT_CONSTANTS.PASSWORD_PROTECTED;
  ENTER_GROUP_PASSWORD: any = COMETCHAT_CONSTANTS.ENTER_GROUP_PASSWORD;
  CREATE_GROUP: any = COMETCHAT_CONSTANTS.CREATE_GROUP;
