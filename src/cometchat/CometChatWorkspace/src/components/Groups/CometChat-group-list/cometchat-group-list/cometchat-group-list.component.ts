...
export class CometChatGroupListComponent
  ...
  decoratorMessage = "";
  searchKey = "";
  selectedGroup: { [key:string]:any | any} = {};
  groupList: any = [];
  groupRequest: any = null;
  groupListenerId = enums.GROUP_LIST_ + new Date().getTime();

  openCreateGroupView: boolean = false;
  GROUPS:any = COMETCHAT_CONSTANTS.GROUPS;
  SEARCH:any = COMETCHAT_CONSTANTS.SEARCH;
   ...
   * @param Event event
   */
  joinGroup(guid: any, groupType: any, password:any) {
    try {
