...
export class CometChatViewGroupMemberListComponent implements OnInit {
  ...
  NAME: any = COMETCHAT_CONSTANTS.NAME;
  SCOPE: any = COMETCHAT_CONSTANTS.SCOPE;
  GROUP_MEMBERS: any = COMETCHAT_CONSTANTS.GROUP_MEMBERS;
  BAN: any = COMETCHAT_CONSTANTS.BAN;
  KICK: any = COMETCHAT_CONSTANTS.KICK;
