...
//  Data Table
@Component({
  selector: 'app-supply-data-res',
  templateUrl: './supply-data-res.component.html',
  styleUrls: ['./supply-data-res.component.scss']
})
export class SupplyDataResComponent implements OnInit {
