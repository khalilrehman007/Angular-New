...
//  Data Table
@Component({
  selector: 'app-listing-monitor-res',
  templateUrl: './listing-monitor-res.component.html',
  styleUrls: ['./listing-monitor-res.component.scss']
})
export class ListingMonitorResComponent implements OnInit {
  ...
  ngAfterViewInit() {
    $(".search-placeholder").select2({ placeholder: "Search" });
  }


  // Listing Status
    public ListingStatusoptions:any= {
    ...
    public ListingStatusData: ChartData<'pie', number[], string | string[]> = {
      labels: [
        "Active",
        "Passive"
      ],
    ...
    public ListingStatusType: ChartType = 'pie';
    public ListingStatusPlugins = [DatalabelsPlugin];

  // Price  Status
  public PriceStatusoptions:any= {
    maintainAspectRatio: false,
    interaction: {
      intersect: false
    },
  ...
  public PriceStatusData: ChartData<'pie', number[], string | string[]> = {
    labels: [
      "Decreased",
      "Increased",
      "No Change"
  ...
  public PriceStatusType: ChartType = 'pie';
  public PriceStatusPlugins = [DatalabelsPlugin];
}
