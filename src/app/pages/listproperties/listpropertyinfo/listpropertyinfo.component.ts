...
export class ListpropertyinfoComponent implements OnInit {
  ...
  getOldFormData(){
    ...
    if(this.oldData != '' && this.oldData != null){
      ...
      this.SubmitForm.controls.bedroom_BHK_1.setValue(this.oldData.bedrooms.bedroom_BHK_1);
      this.SubmitForm.controls.bedroom_BHK_2.setValue(this.oldData.bedrooms.bedroom_BHK_2);
      this.SubmitForm.controls.bedroom_BHK_3.setValue(this.oldData.bedrooms.bedroom_BHK_3);
      this.SubmitForm.controls.bedroom_BHK_4.setValue(this.oldData.bedrooms.bedroom_BHK_4);
      this.SubmitForm.controls.bedroom_BHK_5.setValue(this.oldData.bedrooms.bedroom_BHK_5);
      this.SubmitForm.controls.bedroom_BHK_6.setValue(this.oldData.bedrooms.bedroom_BHK_6);
      this.SubmitForm.controls.bedroom_BHK_7.setValue(this.oldData.bedrooms.bedroom_BHK_7);
      this.SubmitForm.controls.bedroom_BHK_8.setValue(this.oldData.bedrooms.bedroom_BHK_8);
      this.SubmitForm.controls.room_privateBathroom.setValue(this.oldData.bathrooms.room_privateBathroom);
      this.SubmitForm.controls.room_attachedBathroom.setValue(this.oldData.bathrooms.room_attachedBathroom);
      this.SubmitForm.controls.room_sharedBathroom.setValue(this.oldData.bathrooms.room_sharedBathroom);
  ...
  onSubmit() {
    ...
    let bathrooms: Array<any> = [
      {
        room_privateBathroom: this.SubmitForm.value.room_privateBathroom,
        room_attachedBathroom: this.SubmitForm.value.room_attachedBathroom,
        room_sharedBathroom: this.SubmitForm.value.room_sharedBathroom,
      },
    ];

    let bedrooms: Array<any> = [
      {
        bedroom_BHK_1: this.SubmitForm.value.bedroom_BHK_1,
        bedroom_BHK_2: this.SubmitForm.value.bedroom_BHK_2,
        bedroom_BHK_3: this.SubmitForm.value.bedroom_BHK_3,
        bedroom_BHK_4: this.SubmitForm.value.bedroom_BHK_4,
        bedroom_BHK_5: this.SubmitForm.value.bedroom_BHK_5,
        bedroom_BHK_6: this.SubmitForm.value.bedroom_BHK_6,
        bedroom_BHK_7: this.SubmitForm.value.bedroom_BHK_7,
        bedroom_BHK_8: this.SubmitForm.value.bedroom_BHK_8,
      },
    ];
