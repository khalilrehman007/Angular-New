...
@Component({
  selector: 'app-life-at-home-blog',
  templateUrl: './life-at-home-blog.component.html',
  styleUrls: ['./life-at-home-blog.component.scss']
})
export class LifeAtHomeBlogComponent implements OnInit {
