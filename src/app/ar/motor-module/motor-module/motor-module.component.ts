...
@Component({
  selector: 'app-motor-module',
  templateUrl: './motor-module.component.html',
  styleUrls: ['./motor-module.component.scss']
})
export class MotorModuleComponent implements OnInit {
